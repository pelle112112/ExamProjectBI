...
- Random Forest Classifier:
  ...
  The model has very few false positives and false negatives as seen on the confusion matrix in the model below:

![Alt text](./Documentation/Graphs/classification/ConfusionMatrixDecisionTree.png)

Below are the data points for the actual and expected data:
